 ...
 ******************************************************************************/
 ...
 typedef enum ADXL345_Y_AXIS_FLIP {
    ADXL345_Y_AXIS_NORMAL, ADXL345_Y_AXIS_FLIP
} adxl345_Y_AxisFlip;
 ...
 class ADXL345_WE
 {
     public: 
         ...
         /* Constructors */
         ADXL345_WE(uint8_t addr = ADXL345_DEVICE_DAAR,i2c_port_t port = I2C_NUM_0, int sda = GPIO_NUM_39, int scl = GPIO_NUM_40) 
             : i2cAddress{addr}, _port{port}, _sda{sda}, _scl{scl}, useSPI{false} {}
         
         // ADXL345_WE(uint8_t addr = 0x1D) : _wire{&Wire}, i2cAddress{addr}, useSPI{false} {}
         
         // ADXL345_WE(TwoWire *w, uint8_t addr = 0x1D) : _wire{w}, i2cAddress{addr}, useSPI{false} {}
